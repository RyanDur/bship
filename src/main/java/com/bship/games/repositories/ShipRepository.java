...
public class ShipRepository {
    ...
    public Ship create(Ship ship, Long boardId) {
        ...
        template.update(con -> prepareInsertStatement(ship, boardId, con), holder);
        return ship.copy().withBoardId(boardId).withId(holder.getKey().longValue()).build();
    }

    private PreparedStatement prepareInsertStatement(Ship ship, Long boardId, Connection con) throws SQLException {
