...
import com.bship.contracts.EndpointShouldNotBeAbleToPlaceAShipWithoutAnEndBase;
...
public class ShouldNotBeAbleToPlaceAShipWithoutAnEndTest extends EndpointShouldNotBeAbleToPlaceAShipWithoutAnEndBase {
...
MockMvcRequestSpecification request = given()
.header("Content-Type", "application/json")
.body("{\"type\":\"AIRCRAFT_CARRIER\",\"id\":1,\"placement\":{\"x\":0,\"y\":1},\"size\":5}");
...
assertThatJson(parsedJson).array("errors").array("validations").contains("field").isEqualTo("orientation");
