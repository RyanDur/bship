...
import com.bship.contracts.PlaceMoveShouldNotBeAbleToPlaceAMoveOnTheBoardWhereYDoesNotExistBase;
...
public class ShouldNotBeAbleToPlaceAMoveOnTheBoardWhereYDoesNotExistTest extends PlaceMoveShouldNotBeAbleToPlaceAMoveOnTheBoardWhereYDoesNotExistBase {
...
assertThatJson(parsedJson).array("errors").array("validations").field("value").field("x").isEqualTo(5);
assertThatJson(parsedJson).array("errors").array("validations").field("value").field("y").isNull();
