...
import com.bship.contracts.PlaceMoveShouldNotBeAbleMoveOutOfTurnBase;
...
public class ShouldNotBeAbleMoveOutOfTurnTest extends PlaceMoveShouldNotBeAbleMoveOutOfTurnBase {
...
// and:
DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("y").isEqualTo(3);
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("pieces").field("start").field("y").isEqualTo(0);
assertThatJson(parsedJson).array("boards").contains("id").isEqualTo(1);
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(6);
assertThatJson(parsedJson).array("boards").array("moves").contains("status").isEqualTo("MISS");
assertThatJson(parsedJson).array("boards").array("pieces").contains("size").isEqualTo(3);
assertThatJson(parsedJson).array("boards").array("pieces").field("start").field("x").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("opponentMoves").field("point").field("x").isEqualTo(0);
assertThatJson(parsedJson).array("boards").array("pieces").contains("boardId").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("pieces").contains("type").isEqualTo("SUBMARINE");
assertThatJson(parsedJson).array("boards").array("pieces").field("start").field("x").isEqualTo(1);
assertThatJson(parsedJson).array("boards").array("pieces").contains("type").isEqualTo("CRUISER");
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(3);
assertThatJson(parsedJson).array("boards").contains("winner").isEqualTo(false);
assertThatJson(parsedJson).array("boards").contains("id").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(7);
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("x").isEqualTo(4);
assertThatJson(parsedJson).array("boards").array("pieces").contains("type").isEqualTo("DESTROYER");
assertThatJson(parsedJson).array("boards").array("pieces").contains("type").isEqualTo("AIRCRAFT_CARRIER");
assertThatJson(parsedJson).array("boards").array("pieces").contains("size").isEqualTo(4);
assertThatJson(parsedJson).array("boards").array("opponentMoves").contains("status").isEqualTo("MISS");
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("x").isEqualTo(1);
...
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(4);
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("x").isEqualTo(3);
assertThatJson(parsedJson).array("boards").array("pieces").field("start").field("x").isEqualTo(4);
assertThatJson(parsedJson).array("boards").array("pieces").field("start").field("x").isEqualTo(0);
assertThatJson(parsedJson).array("boards").array("pieces").contains("size").isEqualTo(5);
assertThatJson(parsedJson).array("boards").array("moves").contains("id").matches("-?\\d*(\\.\\d+)?");
assertThatJson(parsedJson).array("boards").array("pieces").contains("type").isEqualTo("BATTLESHIP");
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(8);
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("x").isEqualTo(0);
assertThatJson(parsedJson).field("id").isEqualTo(1);
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("y").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("y").isEqualTo(4);
assertThatJson(parsedJson).field("turn").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(1);
assertThatJson(parsedJson).array("boards").array("moves").field("point").field("y").isEqualTo(5);
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("x").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(5);
assertThatJson(parsedJson).array("boards").array("pieces").field("start").field("x").isEqualTo(3);
assertThatJson(parsedJson).array("boards").array("pieces").contains("size").isEqualTo(2);
assertThatJson(parsedJson).array("boards").array("pieces").contains("id").isEqualTo(9);
assertThatJson(parsedJson).array("boards").array("pieces").contains("sunk").isEqualTo(false);
assertThatJson(parsedJson).array("boards").array("opponentMoves").field("point").field("y").isEqualTo(5);
assertThatJson(parsedJson).array("boards").array("pieces").field("end").field("y").isEqualTo(1);
assertThatJson(parsedJson).array("boards").array("pieces").contains("boardId").isEqualTo(1);
}
...
// and:
DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
assertThatJson(parsedJson).array("errors").array("validations").contains("code").isEqualTo("TurnCheck");
assertThatJson(parsedJson).array("errors").array("validations").contains("type").isEqualTo("game");
assertThatJson(parsedJson).array("errors").array("validations").contains("message").isEqualTo("It is not your turn.");
}
